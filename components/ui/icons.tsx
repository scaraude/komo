  ...
  return (
    <IconBase className={className}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.5 2C6.57 2 5 3.57 5 5.5V15.5C5 17.24 6.26 18.68 7.92 18.95L6.2 21.38C5.88 21.83 6 22.46 6.45 22.78C6.9 23.1 7.53 22.98 7.85 22.53L9.65 20H14.35L16.15 22.53C16.47 22.98 17.1 23.1 17.55 22.78C18 22.46 18.12 21.83 17.8 21.38L16.08 18.95C17.74 18.68 19 17.24 19 15.5V5.5C19 3.57 17.43 2 15.5 2H8.5ZM8 6C8 5.45 8.45 5 9 5H15C15.55 5 16 5.45 16 6V10H8V6ZM9 16.5C9.83 16.5 10.5 15.83 10.5 15C10.5 14.17 9.83 13.5 9 13.5C8.17 13.5 7.5 14.17 7.5 15C7.5 15.83 8.17 16.5 9 16.5ZM16.5 15C16.5 15.83 15.83 16.5 15 16.5C14.17 16.5 13.5 15.83 13.5 15C13.5 14.17 14.17 13.5 15 13.5C15.83 13.5 16.5 14.17 16.5 15Z"
      />
    </IconBase>
  )
}
